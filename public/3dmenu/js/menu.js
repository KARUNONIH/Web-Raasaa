var Menu = (function() {
	...
	var $container = $( '#rm-container' ),						
		...
		viewDetails = function( recipe ) {
			...
			var $modal = $( '<div class="rm-modal"><div class="rm-thumb" style="background-image: url(' + img + ')"></div><h5>' + title + '</h5><p><span>' + kategori + '</span></p><p>' + description + '</p><h5>' + harga + '</h5><span class="rm-close-modal">x</span></div>' );
